...
async function getSettingsFile(settings: UserSettings, globs: string | string[]) {
...
export async function compileSettings(opts: CommanderOptionValues, env: "dev" | "prod"): Promise<CompiledSettings> {
